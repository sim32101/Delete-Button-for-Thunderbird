...
The add-on might be available in the official Thunderbird Add-ons Store — please check there first. If you need to install it manually, use the following instructions.
